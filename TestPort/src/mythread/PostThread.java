...
public class PostThread extends Thread {
	...
	private int num;
	public PostThread(int i,String url,String param,Counter a,int num) {super(i+"");this.url=url;this.param=param;this.a=a;this.num=num;}
	public void run() {
		synchronized (a) {
			JTextPane jtp=gui.CreatGui.txtpnprogrammers;
			try{
				String str = web.WebRequest.sendPost(url, param);
